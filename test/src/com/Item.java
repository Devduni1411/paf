...
public class Item {
	...
	public String readItems() {
		...
		try {
			...
			output = "<table class=\"table\" border=\"1\">" + "<tr><th scope=\"col\">Item Code</th>"
					+ "<th scope=\"col\">Item Name</th>" + "<th scope=\"col\">Item Price</th>"
					+ "<th scope=\"col\">Item Description</th>" + "<th scope=\"col\">Update</th>"
